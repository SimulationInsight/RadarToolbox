...
public record FlightpathData
{
    ...
    public double TotalSpeed { get; init; }

    public double TotalSpeed_kts { get; init; }

    public double GroundSpeed { get; init; }

    public double GroundSpeed_kts { get; init; }
    ...
    public double AccelerationVetical { get; init; }
