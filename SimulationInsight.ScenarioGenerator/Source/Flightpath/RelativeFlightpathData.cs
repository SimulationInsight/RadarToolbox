...
{
    public int FlightpathIdOrigin { get; init; }

    public int FlightpathIdTarget { get; init; }
    ...
    public int RangeRate { get; init; }

    public int AzimuthAngleDeg { get; init; }

    public int AzimuthRateDeg { get; init; }

    public int ElevationAngleDeg { get; init; }

    public int ElevationRateDeg { get; init; }
}