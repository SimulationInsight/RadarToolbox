...
```
.
├── SimulationInsight.ESMDataViewer/ - WinUI 3 Desktop app
...
├── SimulationInsight.ESMDataViewer.Core/ - core project (.NET Standard)
│ ├── Contracts/ - class interfaces
│ ├── Helpers/ - static helper classes
│ ├── Models/ - business models
│ └── Services/ - services implementations
├── SimulationInsight.ESMDataViewer (Package)/ - MSIX packaging project
│ ├── Strings/en-us/Resources.resw - localized string resources
