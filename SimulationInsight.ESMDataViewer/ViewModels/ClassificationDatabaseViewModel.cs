...
{
    public class ClassificationDatabaseViewModel : ObservableRecipient, INavigationAware
    {
        ...
        public ClassificationDatabaseViewModel(ISampleDataService sampleDataService)
        {
